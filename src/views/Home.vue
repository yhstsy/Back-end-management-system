...
export default {
  ...
  mounted() {
    getData().then(({ data }) => {
      ...
      const xAris = Object.keys(orderData.data[0]);
      const xArisData = {
        data: xAris,
      };
      echarts1Options.xAxis = xArisData;
      echarts1Options.yAxis = {};
      echarts1Options.legend = xArisData;
      echarts1Options.series = [];
      // console.log("@@@", xArisData);
      xAris.forEach((key) => {
